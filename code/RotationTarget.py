...
'''a class managing an attachment to the cursor like disks and the human'''
class RotationTarget:
    ...
    def setupDisks(self, pencilNode):
        #attaches rotationTarget to pointer
        node.Transform = avango.gua.make_trans_mat(pencilNode.Transform.value.get_translate());
